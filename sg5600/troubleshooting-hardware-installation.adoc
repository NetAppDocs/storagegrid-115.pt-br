...
link:hardware-setup-progress-appears-to-hang.html["A configuração do hardware parece travar"]

link:troubleshooting-connection-issues.html["Solução de problemas de conexão"]
