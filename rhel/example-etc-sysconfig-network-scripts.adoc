...
sidebar: sidebar 
keywords:  
summary: Você pode usar os arquivos de exemplo para agregar quatro interfaces físicas do Linux em uma única ligação LACP e, em seguida, estabelecer três interfaces VLAN que subtendem a ligação para uso como interfaces de rede StorageGRID, Admin e Cliente. 
---
