...
. Retorne à página Instalação do Monitor do Instalador do StorageGRID Appliance inserindo `\http://Controller_IP:8080`, usando o endereço IP do controlador de computação.
+
